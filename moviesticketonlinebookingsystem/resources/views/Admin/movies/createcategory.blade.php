...
<div class="container mx-auto grid place-items-center h-screen">
    <div class="border p-3 w-[40%]">
        ...
        @endif
        <h2 class="text-center font-extrabold">Create Category</h2>
        <form action="{{route('Admin#create')}}" method="post">
            @csrf
            <div>
                <label for="">Name</label>
                <input class="block w-[100%] h-[33px] rounded-lg" type="text" name="categoryName" id="">
            </div>
            <div class="my-2">
